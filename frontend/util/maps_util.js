...
//to update: color to be brand colors
    ...
    // return `https://maps.googleapis.com/maps/api/staticmap?center=New York&size=800x500&maptype=roadmap\&markers=color:blue${inputCoordsStr}&path=color:0x0000ff|weight:5${inputCoordsStr}&key=${ENV['MAPS_API_KEY']}`
