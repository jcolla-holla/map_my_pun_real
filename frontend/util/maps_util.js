...
export function generateGoogleMapsAPIURL(coordsArr) {
    ...
    return `https://maps.googleapis.com/maps/api/staticmap?size=800x400&maptype=roadmap\&markers=size:mid%7Ccolor:red%${inputCoordsStr}&path=color:0x0000ff${pathInputStr}&key=AIzaSyDE9VpHgGqCN8qKXC1wvVlGRxn4JrvnzXs`;
    // return 'placeholder';
}
